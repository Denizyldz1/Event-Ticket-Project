    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> AddCategory(AddCategoryViewModel model)
        {
            ...
            else
            {
                ...
                {
                    var errorMessage = errorObject["errors"]["CategoryName"]?[0]?.ToString();
                ...
                ModelState.AddModelError("CategoryName", errorResponse);
                return View(model);
            }
        }
        ...
        // Gelen BadRequest'i kontrol etme mekanizması Json formatımı veya sadece string ifade mi
